...
<tags:pageTemplate titulo="Clientes Menu - MySys">
    ...
    <jsp:body>
		 ...
		 <form:form action="${s:mvcUrl('CC#alterar').build() }" method="post" modelAttribute="cliente" >
		 	<div class="row">
		 	...
		 	<div>
		 		...
		 		<form:input path="endereco.id" type="hidden" name="endereco.id" class="form-control"/>
		 	</div>
