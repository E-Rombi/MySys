...
<tags:pageTemplate titulo="Usuario Menu - MySys">
    ...
    <main role="main" class="col-md-10 ml-sm-auto col-lg-11 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Usuários - Menu</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
	            <a href="${s:mvcUrl('UC#novo').build() }" />
    	...
    	<section class="table-responsive">
		    	<table class="table table-striped table-dark">
				  <thead class="thead-dark">
				    <tr >
				      <th scope="col"  style="width: 5%;  color: #CCC;" class="h4" ></th>
				      <th scope="col"  style="width: 50%; color: #CCC;" class="h4">Nome</th>
				      <th scope="col"  style="width: 45%; color: #CCC;" class="h4">Email</th>
				      <th scope="col"  style="width: 5%;  color: #CCC;" class="h4"></th>
				      <th scope="col"  style="width: 5%;  color: #CCC;" class="h4"></th>
				    </tr>
				  </thead>
				  <tbody>
				    <c:forEach items="${usuarios }" var="usuario" varStatus="count">
					    <tr>
					      ...
					      <td class="h5">${usuario.nome }</td>
					      <td class="h5">${usuario.email }</td>
					      <td>
					      	<a href="${s:mvcUrl('UC#edit').arg(0, usuario.email).build() }.com">
					      ...
					      <td>
					      	  <a href="${s:mvcUrl('UC#delete').arg(0, usuario.email).build() }.com">
