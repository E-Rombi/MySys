...
<tags:pageTemplate titulo="Usuario Menu - MySys">
    ...
    <jsp:body>
		 ...
		 <form:form action="${s:mvcUrl('UC#inserir').build() }" method="post" commandName="usuario" >
		 	<div class="row">
			 		 		 ...
			 		 		 <tr>
							      ...
							      <td class="h5">
							      	<div class="form-check">
									    <input class="checkPermissao" type="checkbox" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" value="${role.nome }">
								  	</div>
								  </td>
					    	 </tr>
			 		 	</c:forEach>
		 	...
		 	<div>
		 		<button type="submit" class="btn btn-primary submit">Gravar</button>
    ...
    <script type="text/javascript">
    	...
    	sub.addEventListener('click', function () {
    		var pacote = document.querySelector('.checkPermissao');
